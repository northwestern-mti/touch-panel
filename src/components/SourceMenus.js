...
const SourceMenus = () => {
    ...
    return (
        ...
        <div className="col-2 d-flex flex-column text-start sourceSelectMenu" onClick={()=>toggleDisplay('18')}>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'PC') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('200', 'PC')}>
                <i className="bi bi-pc-display me-1"></i> Resident Computer
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'Laptop') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('201', 'Laptop')}>
                <i className="bi bi-laptop me-1"></i> Laptop and Other Sources
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'Wireless') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('202', 'Wireless')}>
            ...
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'ConfCall') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('205', 'ConfCall')}>
                <i className="bi bi-telephone me-1"></i> Conference Call
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'DocCam') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('204', 'DocCam')}>
                <i className="bi bi-journal-text me-1"></i> Document Camera
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'BluRay') ? 'sourceSelectActiveLeft' : ''}`} onClick={() => handleSourceSelected1('203', 'BluRay')}>
        ...
        <div className="col-2 d-flex flex-column text-start sourceSelectMenu" onClick={()=>toggleDisplay('18')}>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source2 == 'PC') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('200', 'PC')}>
                <i className="bi bi-pc-display me-1"></i> Resident Computer
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source2 == 'Laptop') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('201', 'Laptop')}>
                <i className="bi bi-laptop me-1"></i> Laptop and Other Sources
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source1 == 'Wireless') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('202', 'Wireless')}>
                <img className="containter-fluid me-1" src={WirelessIcon} alt='Wireless icon'
                style={{width:'var(--font-size-4'}}></img> Wireless with Solstice
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source2 == 'ConfCall') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('205', 'ConfCall')}>
                <i className="bi bi-telephone me-1"></i> Conference Call
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source2 == 'DocCam') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('204', 'DocCam')}>
                <i className="bi bi-journal-text me-1"></i> Document Camera
            </button>
            <button type="button"
                className={`btn col border-0 border-bottom border-dark font-size-3-xl p-0 py-1 py-xl-2 ${(source2 == 'BluRay') ? 'sourceSelectActiveRight' : ''}`} onClick={() => handleSourceSelected2('203', 'BluRay')}>
                <i className="bi bi-disc me-1"></i> BluRay
            </button>
        </div>
        </div>
